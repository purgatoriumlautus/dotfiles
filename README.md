...
Minimalist Windows 98 rice for Hyprland on Arch Linux. Personal config for celestia (desktop).
...
| Firewall | nftables |
| Music | mpd + rmpc (disabled, WIP) |
| VMs | QEMU/KVM + libvirt + virt-manager |
| Containers | Docker (socket-activated) |
| GTK Theme | Chicago95 |
| Icons | Chicago95 |
